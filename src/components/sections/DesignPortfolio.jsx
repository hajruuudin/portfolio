                ...
                <div id="designProjects" className="standard-padding w-full 2xl:w-5/6 m-auto">
                    ...
                    <section id="basic-info" className="flex flex-col 2xl:flex-row items-center mt-20">
                        <div className="2xl:hidden -ml-12 sm:ml-0 w-screen sm:w-full 2xl:w-1/2 h-full m-auto flex flex-row 2xl:flex-wrap items-center justify-start sm:justify-center  overflow-x-auto 2xl:overflow-hidden">
                            <img src="/portfolio/assets/skyhop/skyhop01.png" alt="" className="w-64 2xl:h-1/4 border-2 rounded-2xl m-3 object-cover"/>
                            <img src="/portfolio/assets/skyhop/skyhop02.png" alt="" className="w-64 2xl:h-1/4 border-2 rounded-2xl m-3 object-cover"/>
                            <img src="/portfolio/assets/skyhop/skyhop03.png" alt="" className="w-64 2xl:h-1/4 border-2 rounded-2xl m-3 object-cover"/>
                            <img src="/portfolio/assets/skyhop/skyhop04.png" alt="" className="w-64 2xl:h-1/4 border-2 rounded-2xl m-3 object-cover"/>
                        </div>
                        <div className="hidden 2xl:flex 2xl:w-1/2 h-full flex flex-col items-end mr-10">
                            <img src="/portfolio/assets/skyhop/skyhop.png" alt="" className="2xl:w-image rounded-2xl"/>
                        </div>
                        <div className="w-full 2xl:w-1/2 h-full flex flex-col justify-center items-center 2xl:items-start">
                            ...
                            <div className="hidden 2xl:inline flex flex-row items-center justify-start">
                                <img src="/portfolio/assets/skyhop/skyhop01.png" alt="" className="w-40 inline rounded-2xl m-3 object-cover"/>
                                <img src="/portfolio/assets/skyhop/skyhop02.png" alt="" className="w-40 inline rounded-2xl m-3 object-cover"/>
                                <img src="/portfolio/assets/skyhop/skyhop03.png" alt="" className="w-40 inline rounded-2xl m-3 object-cover"/>
                                <img src="/portfolio/assets/skyhop/skyhop04.png" alt="" className="w-40 inline rounded-2xl m-3 object-cover"/>
                            </div>
                    ...
                    <section id="basic-info" className="flex flex-col 2xl:flex-row items-center mt-20 pb-20">
                        <div className="hidden 2xl:flex 2xl:w-1/2 h-full flex flex-col items-end mr-10">
                            <img src="/portfolio/assets/mediasphere/mediasphere.png" alt="" className="w-image rounded-2xl m-4"/>
                        </div>
                        <div className="w-full 2xl:w-1/2 h-full flex flex-col justify-center items-center 2xl:items-start">

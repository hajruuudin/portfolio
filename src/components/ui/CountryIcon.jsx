    ...
    if(country === 'de'){
        return(
            <div className="w-94 h-94 bg-antique-dark-two flex flex-col items-center justify-center p-10 rounded-3xl m-3">
                <img src="/portfolio/assets/icons/de.png" alt="" className="w-32 h-32"/>
        ...
        return(
            <div className="w-94 h-94 bg-antique-dark-two flex flex-col items-center justify-center p-10 rounded-3xl m-3">
                <img src="/portfolio/assets/icons/ba.png" alt="" className="w-32 h-32"/>
            ...
            return(
            <div className="w-94 h-94 bg-antique-dark-two flex flex-col items-center justify-center p-10 rounded-3xl m-3">
                <img src="/portfolio/assets/icons/gb.png" alt="" className="w-32 h-32"/>
